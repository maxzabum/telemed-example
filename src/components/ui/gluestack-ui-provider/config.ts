...
export const config = {
  light: vars({
    ...
    //Text
    '--color-semantic-text-general-standard-default': '70 70 70',
    '--color-semantic-text-CTAButtonFilled-secondary-default': '60 108 231',
    '--color-semantic-text-inputText-inputHead-default': '70 70 70',
    '--color-semantic-text-inputText-placeholder-empty': '180 180 180',

    //Button
    '--color-semantic-surface-CTAButtonFilled-secondary-default': '236 243 255',

    //Icon
    '--color-semantic-icon-inputText-asterisk-default': '131 131 131',

    //Border
    '--color-semantic-border-inputText-textField-default': '207 207 207',
    '--color-semantic-border-inputText-textField-focused': '60 108 231',

    //Background
    '--color-semantic-background-general-standard-default': '255 255 255',
    /* Semantic Colors */
