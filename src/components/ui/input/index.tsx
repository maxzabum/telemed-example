...
const inputStyle = tva({
  base: 'border-background-300 flex-row overflow-hidden content-center data-[hover=true]:border-outline-400 data-[focus=true]:border-semantic-border-inputText-textField-focused data-[focus=true]:hover:border-primary-700 data-[disabled=true]:opacity-40 data-[disabled=true]:hover:border-background-300 items-center',
    ...
    return (
      <Box
        ...
        style={{
          ...
          // shadowOpacity: 1,
          // shadowRadius: 4,
          boxShadow: '0px 0px 0px 4px #C4DAFF',
        }}>
        {/* <Box className="bg-semantic-background-general-standard-default rounded-xl"> */}
        <UIInput
          ref={ref}
          {...props}
